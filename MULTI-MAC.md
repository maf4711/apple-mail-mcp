...
| | |
|---|---|
| GitHub | `maf4711/apple-mail-mcp` |
| SSH | `git@github.com:maf4711/apple-mail-mcp.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/apple-mail-mcp.git` |
| Ordner | `~/Developer/apple-mail-mcp` |
| Default-Branch | `main` |

### Release

- GitHub Actions: `ci.yml`, `codeql.yml`, `dependabot-automerge.yml`, `dependabot-rebuild.yml`, `publish.yml`, `scorecard.yml`, `version-guard.yml`. Der Default-Branch bleibt der auslieferbare Stand.
...
3. Dieser Checkout liegt danach unter `~/Developer/apple-mail-mcp`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
